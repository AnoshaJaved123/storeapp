...
const Itemform = () => {
    ...
    const [values, setvalues] = useState({name:"", detail:"", location:"",price:0,like:0, picURL:""})
    ...
    const handleSubmit = (e)=>{
        ...
        setvalues({name:"", detail:"", location:"",price:0, like:0, picURL:""})
  ...
  return (
   ...
   <div className="row ">
     ...
     <div className="card my-1" style={{background:'#f95959'}}>
         ...
         <form className="card-body cardbody-color p-lg-4" onSubmit={handleSubmit} method='POST' action='/createitem' encType="multipart/form-data">
